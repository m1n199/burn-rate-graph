...
function CreateGraph() {
  ...
  if (BurnOutData[BurnOutData.length - 1] && BurnOutData[BurnOutData.length - 1] > 0) BurnRateSatus("Burn Rate Positive +ve !");
  else BurnRateSatus("Burn Rate Negative -ve !");
}
